...
#$ -N testsum            # Specify job name
#$ -t 1-9                # Number of tasks--make sure arglist below 
...
set arglist = ( \
	"-o usTest01 -b 1000 -N 50 -l 0" \
	"-o usTest02 -b 1000 -N 50 -l 0" \
	"-o usTest03 -b 1000 -N 50 -l 0" \
	"-o usTest04 -b 1000 -N 50 -l 0" \
	"-o usTest05 -b 1000 -N 50 -l 0" \
	"-o usTest06 -b 1000 -N 500 -l 0" \
	"-o usTest07 -b 1000 -N 500 -l 0" \
	"-o usTest08 -b 1000 -N 500 -l 0" \
	"-o usTest09 -b 1000 -N 500 -l 0" \
)
